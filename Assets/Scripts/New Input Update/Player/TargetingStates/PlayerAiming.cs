...
public class PlayerAiming : MonoBehaviour
{
    ...
    private cursorState currentState = cursorState.USELESS;
    ...
    void Update()
    {
        switch (currentState)
        {
            case cursorState.USELESS:
                return;
            case cursorState.TARGETING:
                TargetingStateUpdate();
                return;
            case cursorState.INUSE:
                HookingStateUpdate();
                return;
        }
    ...
    private void TargetingStateUpdate()
    {

    }
    private void HookingStateUpdate()
    {
